...
IND_STATES = (
    ("Andhra Pradesh", "Andhra Pradesh"), ("Arunchal Pradesh",
                                           "Arunchal Pradesh"), ("Assam", "Assam"), ("Bihar", "Bihar"),
    ("Chhattisghar", "Chhattisghar"), ("Goa", "Goa"), ("Gujarat",
                                                       "Gujarat"), ("Haryana", "Haryana"), ("Himachal Pradesh", "Himachal Pradesh",),
    ("Jammu and Kashmir", "Jammu and Kashmir"), ("Jharkhand",
                                                 "Jharkhand"), ("Karnataka", "Karnataka"), ("Kerala", "Kerala"),
    ("Madhya Pradesh", "Madhya Pradesh"), ("Maharashtra",
                                           "Maharashtra"), ("Manipur", "Manipur"), ("Meghalaya", "Meghalaya"),
    ("Mizoram", "Mizoram"), ("Nagaland", "Nagaland"), ("Odisha",
                                                       "Odisha"), ("Punjab", "Punjab"), ("Rajashtan", "Rajashtan"),
    ("Sikkim", "Sikkim"), ("Tamil Nadu", "Tamil Nadu"), ("Telangana",
                                                         "Telangana"), ("Tripura", "Tripura"), ("Uttar Pradesh", "Uttar Pradesh"),
...
class Profile(models.Model):
    ...
    prefHospital = models.ForeignKey(
        Hospital, null=True, related_name="profile_prefhospital", on_delete=models.CASCADE)
    primaryCareDoctor = models.ForeignKey(
        'Account', null=True, related_name="profile_primarycaredoctor", on_delete=models.CASCADE)
    speciality = models.ForeignKey(
        'Speciality', null=True, max_length=4000, on_delete=models.CASCADE)
...
class Action(models.Model):
    ...
    account = models.ForeignKey(
        Account, related_name="actions_account", on_delete=models.CASCADE)


class Appointment(models.Model):
    doctor = models.ForeignKey(
        Account, related_name="appointment_doctor", on_delete=models.CASCADE)
    patient = models.ForeignKey(
        Account, related_name="appointment_patient", on_delete=models.CASCADE)
...
class Message(models.Model):
    target = models.ForeignKey(
        Account, related_name="message_target", on_delete=models.CASCADE)
    sender = models.ForeignKey(
        Account, related_name="message_sender", on_delete=models.CASCADE)
...
class Notification(models.Model):
    account = models.ForeignKey(
        Account, related_name="notifications_account", on_delete=models.CASCADE)
...
class Prescription(models.Model):
    patient = models.ForeignKey(
        Account, related_name="prescription_patient", on_delete=models.CASCADE)
    doctor = models.ForeignKey(
        Account, related_name="prescription_doctor", on_delete=models.CASCADE)
...
class MedicalInfo(models.Model):
    ...
    account = models.ForeignKey(
        Account, related_name="medicalinfo_account", on_delete=models.CASCADE)
...
class MedicalTest(models.Model):
    ...
    description = models.CharField(max_length=200)
    doctor = models.ForeignKey(
        Account, related_name="medicaltest_doctor", on_delete=models.CASCADE)
    patient = models.ForeignKey(
        Account, related_name="medicaltest_patient", on_delete=models.CASCADE)
    private = models.BooleanField(default=True)
    completed = models.BooleanField()
    image1 = models.FileField(blank=True, null=True,
                              upload_to='medicaltests/%Y/%m/%d')
